...
MAPEO_COBERTURA = {
    ...
    "URBANO CONSTRUIDO":                                        ("asentamiento", "asentamiento_humano",   None,           False, False),
    "ÁREA DESPROVISTA  DE VEGETACION":                          ("sin_veg",      "desprovisto",           None,           False, False),
    ...
    "VEGETACIÓN SECUNDARIA ARBÓREA DE BOSQUE DE CEDRO":         ("bosque",      "bosque_cedro",            "sec_arborea",   True, True),
    ...
    "SELVA DE GALERÍA":                                         ("selva",       "selva_galeria",                 "primaria", True,  True),
    ...
    "VEGETACIÓN SECUNDARIA ARBÓREA DE SELVA DE GALERÍA":             ("selva",  "selva_galeria",                 "sec_arborea",   True, True),
    ...
    "VEGETACIÓN SECUNDARIA ARBÓREA DE MANGLAR":                 ("manglar",     "manglar",                 "sec_arborea",   True, True),
    ...
    "VEGETACIÓN HALOFILA HIDROFILA":                            ("otro",        "vegetacion_halofila",     "primaria",     False, True),
    "VEGETACIÓN SECUNDARIA ARBUSTIVA DE CHAPARRAL":             ("otro",        "chaparral",               "sec_arbustiva", False, True),
    "VEGETACIÓN SECUNDARIA ARBUSTIVA DE MATORRAL CRASICAULE":   ("otro",        "matorral_crasicaule",     "sec_arbustiva", False, True),
    ...
    "AGUA":                                                     ("agua",        "cuerpo_agua",             None,           False, False),
...
MAPEO_SERIE_II = {
    ...
    "VEGETACION HALOFILA":              ("otro",     "vegetacion_halofila",          "primaria",  False, True),
    "VEGETACION HALOFILA HIDROFILA":    ("otro",     "vegetacion_halofila",          "primaria",  False, True),
...
def aplicar_mapeo(descripcion):
    """Busca primero en el mapeo principal (nomenclatura moderna),
    y si no encuentra, cae al mapeo de Serie II (nomenclatura 90s)."""
    resultado = MAPEO_COBERTURA.get(descripcion)
    if resultado is None:
        resultado = MAPEO_SERIE_II.get(descripcion)
    if resultado is None:
        return ("sin_clasificar", "sin_clasificar", None, False, False)
    return resultado